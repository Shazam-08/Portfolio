...
import Python from "../assets/Certificates/KagglePython.png";
import TCS from "../assets/Certificates/TCSiON.jpg";
import ReactJS from "../assets/Certificates/coursera.png";
        ...
        <div className="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            {/* <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://www.udemy.com/certificate/UC-d2e99ccb-4ea2-42b4-b44c-a232bf3412bc/"
                  target="new"
                >
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://www.hackerrank.com/certificates/770a3c68cecb"
                  target="new"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Verify
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://www.hackerrank.com/certificates/68f5eadcaa81"
                  target="new"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Verify
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://drive.google.com/file/d/1w4VObVKVfSlycDelJuDwBWjY5RI6BzNF/view"
                  target="new"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    View
          ...
          >
            {/* <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://www.kaggle.com/learn/certification/hneelabh/python"
                  target="new"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Verify
